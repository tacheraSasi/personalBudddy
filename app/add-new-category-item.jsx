...
export default function AddNewCategoryItem() {
    ...
    const backupImageUrl = 'https://ekilie.com/assets/img/favicon.jpeg'
    ...
    const onClickAdd=async()=>{
        ...
        const fileName=`${Date.now()}_${name}_${user.email}`;
        ...
        if(data){
            const fileUrl="https://vsdatefhlaxwcjynbcyw.supabase.co/storage/v1/object/public/images/"+fileName+".png";
            console.log(fileUrl)
            ...
            .insert([{
                ...
                cost:cost,
                url:url,
                image:image?fileUrl:backupImageUrl,
                note:note,
